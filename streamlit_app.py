...
if menu == "Check-in Diário 📝":
...
else: # PAINEL ANALÍTICO (INTELIGÊNCIA CLÍNICA E PREVISIBILIDADE)
    ...
    if not df.empty:
        ...
        # 1. Processamento e Lógica de Função
        ...
        # --- NOVO: LÓGICA DE PREVISIBILIDADE DE ALTA (MATEMÁTICA PBE) ---
        # Calculamos a tendência baseada na evolução do Score de Função ao longo dos dias
        try:
            ...
            # Estimamos o dia em que o paciente atingirá 9.0 (90% de função)
            ...
            if dia_estimado_alta > 0:
                ...
                prev_txt = "Estável / Monitorar"
        except:
            prev_txt = "Análise em curso"
        ...
        # 3. GERAÇÃO DE GRÁFICOS (V18.4 - LEGENDAS E BUFFERS PARA PDF)
        ...
        lgd_ev = ax_ev.legend(loc='upper center', bbox_to_anchor=(0.5, -0.2), ncol=2, frameon=False, fontsize=10)
        buf_ev = io.BytesIO()
        ...
        with t1:
            ...
            st.success(f"🔮 **Inteligência GENUA:** Com base na velocidade de ganho funcional, a previsão estimada de alta é **{prev_txt}**.")
        with t2:
        ...
        pdf_metrics = {
            ...
            'alta': prev_txt # AGORA ENVIADO PARA O PDF
        }
